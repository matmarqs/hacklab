...
Describe "Basic Verbs" {
    ...
    Context "Add" {
        ...
        It 'is for commands that append data' {
            ...
            #>
            $Answers = "Add-Content", "Add-History", "Add-Member", "Add-Type", "Add-AssertionOperator"
        ...
        It 'can Add-Content to a file' {
            <#
                ...
                Add-Content.
            #>
            "Mountains are merely mountains." | New-Item -Path $FilePath
            ...
            'Whatever' | Add-Content -Path $FilePath
            'you' | Add-Content -Path $FilePath
            'like' | Add-Content -Path $FilePath
